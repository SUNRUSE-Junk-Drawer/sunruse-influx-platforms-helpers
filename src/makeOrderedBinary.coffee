module.exports = (name, inputType, outputType, forConstants, generateCode) ->
	instance = 
		...
		inputsEqual: (platform, a, b) ->
			(module.exports.toolchain.valuesEquivalent platform, a.properties.a, b.properties.a) and (module.exports.toolchain.valuesEquivalent platform, a.properties.b, b.properties.b)
